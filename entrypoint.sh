...
UUID=${UUID:-'f42c876d-cded-411c-a893-a9535b00ebce'}
VMESS_WSPATH=${VMESS_WSPATH:-'/f42c876d-cded-411c-a893-a9535b00ebce-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/f42c876d-cded-411c-a893-a9535b00ebce-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/f42c876d-cded-411c-a893-a9535b00ebce-trojan'}
SS_WSPATH=${SS_WSPATH:-'/f42c876d-cded-411c-a893-a9535b00ebce-shadowsocks'}
